...
class CategoryExpenseTotal {
  ...
  const CategoryExpenseTotal({required this.category, required this.total});
}
...
class AppDatabase extends _$AppDatabase {
  ...
  Future<List<ExpenseWithCategory>> getExpensesWithCategoryByPeriod(
    ...
    final joinedRows =
        await (select(expenses).join([
                innerJoin(
                  categories,
                  categories.id.equalsExp(expenses.categoryId),
                ),
              ])
              ..where(
